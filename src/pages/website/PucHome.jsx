...
const PucHome = () => {
  ...
  const testimonials = [
    {
      text: "The faculty at  Shri Annadaneshwar Indipendent Pu College provided me with the perfect foundation for my engineering career. Their dedication to student success is unmatched.",
      author: "Rahul Sharma",
      role: "Class of 2023",
    },
    {
      text: "The holistic approach to education at  Shri Annadaneshwar Indipendent Pu College helped me develop both academically and personally. I'm grateful for the supportive environment.",
      author: "Priya Patel",
      role: "Class of 2024",
    },
  ];
        ...
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl md:text-2xl font-bold text-gray-800">
            <span className="text-blue-700">
              Shri Annadaneshwar Indipendent Pu College
            </span>
          </h1>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Shri Annadaneshwar Indipendent Pu College has been a pioneer in
              pre-university education, shaping young minds for over three
              decades.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                At Shri Annadaneshwar Indipendent Pu College, we are dedicated
                to delivering top-tier pre-university education with a focus on
                innovation, practical learning, and holistic development.
              </p>
      ...
      <section id="testimonials" className="py-16 px-6 bg-white relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Hear from our alumni about their experiences at Shri Annadaneshwar
              Indipendent Pu College
            </p>
          </motion.div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-gray-600">
                        Shri Annadaneshwar Indipendent Pu College Munavalli,
                        Manolli, Karnataka, Munuvalli-591117
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-gray-600">admissions@puc.edu.in</div>
                    </div>
                  </div>
                </div>
      ...
      <footer className="bg-gradient-to-r from-gray-800 to-gray-900 text-white py-12 relative z-10">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="border-t border-gray-700 mt-10 pt-6 text-center text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} Shri Annadaneshwar Indipendent Pu
